...
@section('title', 'Markedia - Blog:: Search') {{-- Передаем второй аргумент-значение вместо закрывающего тега @endsection --}}
...
@section('content')
    <div class="page-wrapper">
        <div class="blog-custom-build">
                ...
                @foreach($posts as $post)
                    ...
                    <div class="blog-box wow fadeIn">
                        ...
                        <div class="blog-meta big-meta text-center">
                            ...
                            {!! $post->description !!} {{-- В тексте цитаты могут быть различные теги для оформления текста статьи, чтобы их рендерить а не просто отображать как символы, мы используем {!! !!} --}}
            ...
            @else
                По Вашему запросу "{{ $s }}" ничего не найдено!
        ...
        <div class="col-md-12">
            <nav aria-label="Page navigation">
                <div class="pagination justify-content-center">
                    {{ $posts->appends (['s' => request()->s])->links ('vendor.pagination.bootstrap-4') }} {{-- Метод appends ([]) позволяет добавить дополнительные get параметры к нашему запросу (['s' => $request()->s])--}}
                </div>
