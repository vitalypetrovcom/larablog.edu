...
<title>Markedia - Single Blog Template</title>
...
<!-- Подключаем общий файл стилей front.css -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="{{ route('posts.single') }}" title="">We are guests of ABC Design Studio</a></h4>
                                ...
                                <div class="col-lg-6">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="{{ route('posts.single') }}" title="">Nostalgia at work with family</a></h4>
...
<!-- Подключаем общий файл скриптов front.js -->
