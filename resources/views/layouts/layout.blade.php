...
<title>Markedia - Index Template</title>
...
<div id="wrapper">
    ...
    <section class="section lb @if (!Request::is('/')) m3rem @endif "> {{-- Проверяем, находимся ли мы на главной странице или нет используя @if (!Request::is('/')) m3rem @endif --}}
        <div class="container">
            <div class="row">
